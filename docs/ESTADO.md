...
- **La pestaña «Certificar» (19/9) arma la certificación de una resolución
  ...
  **El hash no va al texto ni al QR, por decisión de Javier** —se muestra en
  pantalla con el peso, sin botón de copiar, y nada más—: la página no puede bajar el PDF del
