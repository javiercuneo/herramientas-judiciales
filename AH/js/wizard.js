        ...
        if (step === 0) {
            ...
            selObj.addEventListener('change', (e) => {
                ...
                if (wizardState.objetoBase === 'desalojo') {
                    div.innerHTML = `<div class="legal-box">Seleccione el tipo de locación:</div><select id="tipoLocacion" class="input-ui"><option value="">-- Seleccione --</option><option value="vivienda">Alquiler para vivienda</option><option value="civil">Demás casos civiles</option><option value="laboral">Desalojo laboral</option></select><div id="locacionMensaje"></div>`;
                    ...
                    selLoc.addEventListener('change', (e2) => {
                        ...
                        } else if (wizardState.desalojoVivienda === 'laboral') {
                            msgDiv.innerHTML = `<div class="legal-box">Desalojo laboral: la base se calcula según art. 43</div>`;
                        } else {
                            msgDiv.innerHTML = '';
                        }
                    });
